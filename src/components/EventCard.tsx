    ...
    return (
        <Link href={`/events/${event.id}`}>
            <motion.div
                ...
                viewport={{ once: true }}
                className="h-full flex md:flex-row gap-5 border border-zinc-700 rounded-md hover:invert-100 filter bg-gradient-to-bl from-black to-zinc-700 p-6 transition-all duration-300"
            >
